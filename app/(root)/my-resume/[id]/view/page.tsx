...
export async function generateMetadata({
  ...
  if (resume?.firstName === undefined && resume?.lastName === undefined) {
    return {
      title: "OzBuild - Professional AI Resume Builder",
      description:
  ...
  return {
    ...
    ${resume?.lastName}${resume?.lastName && " "}- OzBuild`,
    description: `${resume?.firstName} ${resume?.lastName}'s Resume. Powered by OzBuild.`,
  };
}
